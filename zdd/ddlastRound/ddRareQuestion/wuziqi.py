'''
https://www.1point3acres.com/bbs/thread-1050228-1-1.html
个人出题 国人小哥
让写一个五子棋 输入输出都自己想
博弈论
10*10 grid as map
input : x player's input tuble
        y player's input tuble

process:
      any input will place a player flag in the map
      check row/col/digonal/antidigonal
      if any play has 5 in row. end game
'''
